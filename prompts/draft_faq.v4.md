...
The answer text is published copy. Never mention the evidence pack, the sources, the questions or these instructions in it. If you find yourself describing what evidence exists, the answer is null. Never state what the evidence does not say.
...
Do not repeat a caveat across answers. If several answers rest on the same disputed claim, state the limitation once, in the answer where it matters most.
